...
const TestimonialSlider = () => {
	const data = [
		...
		
		{
			...
			quote: `“I was a commerce student E-Coaching helped me learn the everything I needed to become an Android developer starting from basics to expert level.”`,
			studentImage:
            ...
            >
                {data.map((item, index) => (
                        ...
                        <div className="py-10 px-2">
                            <div className="text-center h-[300px] flex justify-between flex-col py-10 px-4 card !rounded-lg shadow bg-base-100 dark:bg-primary-5">
                                <div>
