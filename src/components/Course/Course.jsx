            ...
            <Link to={`/course-detail/${course.id}`} className="">
                <div className="relative">
                    <div className="">
                        ...
                        <div className="p-2">
                            <h1 className="dark:text-base-100 text-neutral-focus text-xl md:text-base mb-2">{course.title.length > 50 ? course.title.slice(0, 50) : course.title}</h1>
                            ...
                            <h3 className="text-sm text-neutral dark:text-base-300  mt-2">
                                <span className="text-primary-300 font-semibold">${(course.price - calcDiscountPrice(course.price, course.discount)).toFixed(2)}</span>
                                <span className="text-gray-400 ml-3 line-through">${calcDiscountPrice(course.price, course.discount).toFixed(2)} Off</span>
                            </h3>
                        </div>
                    </div>
                </div>
