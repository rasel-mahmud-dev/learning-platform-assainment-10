...
const Navigation = () => {
	const {
		state: {auth, isDarkMode}, actions: {logOutHandler, toggleTheme},
                ...
                <div className="container">
                    ...
                    <div className="flex-none ml-3">
                        ...
                        >
                                <label tabIndex={0} className="btn btn-ghost btn-circle avatar">
                                    <div className="avatar placeholder">
                                        <div className="bg-neutral-focus text-neutral-content rounded-full w-9">
                                            {auth.photoURL ? (<img src={auth.photoURL} alt="avatar"/>) : (
                                ...
                                <ul
		                                tabIndex={0}
		                                className={`absolute opacity-0 z-50 invisible top-8 -right-3 mt-3 p-4 bg-base-100 dark:bg-dark-10 shadow-around  rounded-box w-52 ${openAuthMenu ? "!opacity-100 !visible" : ""}`}
                                >
